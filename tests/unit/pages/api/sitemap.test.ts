...
describe('Sitemap  API endpoint', () => {
  test('Should return xml sitemap', async () => {
    ...
    expect(res._getData().includes('<url><loc>https://viking-language-dictionary.test/word/herja</loc><changefreq>monthly</changefreq><priority>0.5</priority></url>')).toBeTruthy() // eslint-disable-line
  })
})
