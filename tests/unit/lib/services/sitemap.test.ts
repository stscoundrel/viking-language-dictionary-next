...
describe('Sitemap tests', () => {
  ...
  test('Sitemap content can be formatted to XML.', async () => {
    ...
    expect(result.includes('<url><loc>https://viking-language-dictionary.test/word/skilja</loc><changefreq>monthly</changefreq><priority>0.5</priority></url>')).toBeTruthy()
  })
})
